...
public class ManagerOrgInfoController {
    ...
    @RequestMapping(value = "/manager/org-registration-application")
    public String showRegistrationApplicationPage(Model model, HttpSession session) {
        ...
        return "manager/org-registration-application";
    }

    @RequestMapping(value = "/manager/org-info-change-application")
    public String showInfoChangeApplicationPage(Model model, HttpSession session) {
        model.addAttribute("manager", session.getAttribute("manager"));
        ...
        return "manager/org-info-change-application";
    }
    ...
    public String approveApplication(Model model, HttpSession session, @PathVariable(value = "orgCode") final String orgCode, RedirectAttributes redir) {
        ...
        if (organization == null) {
            ...
            return "redirect:/manager/org-registration-application";
        } else {
    ...
    public String approveInfoChange(Model model, HttpSession session, @PathVariable(value = "id") final int id, RedirectAttributes redir) {
        ...
        if (application == null) {
            redir.addFlashAttribute("errorMessage", "No such application!");
            return "redirect:/manager/org-info-change-application";
        } else {
